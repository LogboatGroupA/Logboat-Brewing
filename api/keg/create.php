...
try {
    ...
    $theKeg = $kegId[0];
    $name = Database::runQuery("INSERT INTO kegorder (customerId,userId,kegId) VALUES(:customerId,:userId,:kegId)",array("customerId" => 31, "userId" => $_SESSION['userId'], "kegId" => $theKeg['id']));
    success();
